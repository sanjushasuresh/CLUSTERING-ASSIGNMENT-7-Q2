# -*- coding: utf-8 -*-
"""
Created on Tue Nov 16 11:40:49 2022
...
# K-means is considered as the simplest and quickest one which guarantees convergence but also
# it cannot handle noisy data and outliers and DBSCAN can handle the noise very well, but struggles 
# with high dimensionality data.
